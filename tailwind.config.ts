...
export default {
	...
	theme: {
        ...
        'glow-click': {
          '0%': { boxShadow: '0 0 0 rgba(174, 227, 245, 0.6)' },
          '50%': { boxShadow: '0 0 20px rgba(174, 227, 245, 0.8)' },
          '100%': { boxShadow: '0 0 0 rgba(174, 227, 245, 0)' },
        }
			},
			animation: {
        ...
        'glow-click': 'glow-click 0.4s ease-out'
			}
		}
	},
