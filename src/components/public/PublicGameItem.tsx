    ...
    <div className="relative bg-gradient-to-r from-white/5 to-white/10 border border-white/20 rounded-xl p-4 hover:from-white/10 hover:to-white/15 transition-all duration-300 hover:border-white/30 hover:shadow-lg hover:shadow-white/5 max-w-xs mx-auto">
      ...
      <div className="flex items-stretch h-24">
        ...
        <div className="flex-1 flex flex-col justify-between pr-3">
          ...
          <div className="text-white/70 text-xs text-center leading-tight">
            {Math.round(fadeZonePercentage)}% of FadeZone users are on {game.team} {game.spread}
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col justify-between pl-3">
          ...
          <div className="text-white/70 text-xs text-center leading-tight">
            {game.publicPercentage}% of the public is on {game.team} {game.spread}
          </div>
        </div>
      </div>
