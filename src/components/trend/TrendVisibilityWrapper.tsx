...
type TrendVisibilityWrapperProps = {
  children: (isVisible: boolean, isMostVisible: boolean) => ReactNode;
};

const TrendVisibilityWrapper = ({ children }: TrendVisibilityWrapperProps) => {
  ...
  return (
    <div ref={itemRef} className="trend-item">
      {children(isVisible, isMostVisible)}
    </div>
  );
};

export default TrendVisibilityWrapper;
