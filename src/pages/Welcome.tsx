      ...
      <div className="relative z-10 text-center max-w-sm mx-auto flex flex-col justify-center min-h-screen">
        ...
        <div className="flex items-center justify-center mb-8 space-x-2">
          ...
          <div className="text-center flex-1">
            <div className="w-12 h-12 mx-auto mb-2 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center border border-white/20">
              <Eye className="w-6 h-6 text-white" />
            </div>
            <h3 className="text-xs font-semibold mb-1 text-white">Track anonymous bettors</h3>
        ...
        {/* Value Proposition */}
        <div className="mb-8">
          <p className="text-xl font-medium text-white mb-2">No picks. No touts. Just data.</p>
          <p className="text-base text-white/60">Cold bettors make the market. You ride the other side.</p>
        </div>
        
        {/* CTA Button */}
        <Button
          onClick={handleStartFading}
          className="px-8 py-3 text-base font-semibold bg-white/10 hover:bg-white/20 text-white rounded-full border border-white/30 backdrop-blur-sm transition-all duration-300 hover:scale-105"
        >
          START FADING
        </Button>
      </div>
