      ...
      <div className="max-w-md mx-auto w-full px-4">
        ...
        <div className="flex items-center pt-4 mb-6">
          <Button
            ...
            className="text-[#AEE3F5] hover:bg-[#AEE3F5]/10 mr-3"
          >
            <ArrowLeft className="h-6 w-6" />
          </Button>
          <h1 className="text-2xl font-bold text-white font-rajdhani tracking-wider">
            Settings
          </h1>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-black border-white/10">
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <Button variant="outline" className="border-[#AEE3F5] text-[#AEE3F5] hover:bg-[#AEE3F5]/10">
                  Upgrade
                </Button>
              </div>
          ...
          <Card className="bg-black border-white/10">
            <CardHeader>
              <CardTitle className="text-white">Connected Sportsbooks</CardTitle>
              <CardDescription className="text-gray-400">
            ...
            <CardContent className="space-y-4">
              <div className="text-center py-4">
                <p className="text-gray-400 mb-4">No sportsbooks connected</p>
                <Button 
